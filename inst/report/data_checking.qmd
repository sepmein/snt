...
p_outliers_1 <- t |> plot_outliers(allout_ov5,
                         allout_u5,
                         allout)
ggplotlyr(p_outliers_1)
p_outliers_2 <- t |> plot_outliers(maldth_ov5,
                         maldth_u5,
                         maldth,
                         maltreat_ov5,
                         maltreat_u5,
                         ...
                         conf,
                         test)
ggplotlyr(p_outliers_2)
p_outliers_3 <- t |> plot_outliers(maladm,
                         maladm_ov5,
                         maladm_u5,
                         alladm,
                         alladm_ov5,
                         alladm_u5)
ggplotlyr(p_outliers_3)
...
#| fig-height: 5
#| fig-width: 12
p_hf_report_status <- t |> 
  plot_hf_report_status(
    check_overlap = TRUE,
    date_labels = "%Y",
    adm0, adm1, adm2, adm3, hfname, year, month)
ggplotlyr(p_hf_report_status)
```
