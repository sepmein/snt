...
color <- list(
  itn = list(
    pbo = pbo, llins = llins, dual_ai = dual_ai, urban_pbo = urban_pbo,
    urban_llins = urban_llins, urban_dual_ai = urban_dual_ai
  ),
  smc = smc, pmc = pmc, irs = irs, vaccine = list(
    vac1p = vac1p, vac1 = vac1, vac2 = vac2, vac3 = vac3,
    vac4 = vac4, vac5 = vac5, no_vac = no_vac
  ),
  no_intervention = no_intervention, strategy = list(
    cm_iptp_llins = cm_iptp_llins, cm_iptp_llins_smc = cm_iptp_llins_smc,
    cm_iptp_pbo = cm_iptp_pbo, cm_iptp_pbo_smc = cm_iptp_pbo_smc,
    cm_iptp_dui_ai = cm_iptp_dui_ai, cm_iptp_pbo_pmc = cm_iptp_pbo_pmc,
